...
var ProfileListComponent = /** @class */ (function (_super) {
    ...
    ProfileListComponent.prototype.performInitialProfile = function (list) {
        ...
        var _loop_2 = function (x) {
            ...
            var dsResult = 0;
            var msResult = 0;
            var getSDGrade = x.grades.filter(function (c) { return c.courseSpecialization === 'SD'; }).forEach(function (f) { return sdResult += Number(f.value); });
            var getDSGrade = x.grades.filter(function (c) { return c.courseSpecialization === 'DS'; }).forEach(function (f) { return dsResult += Number(f.value); });
            var getMSGrade = x.grades.filter(function (c) { return c.courseSpecialization === 'MS'; }).forEach(function (f) { return msResult += Number(f.value); });
            sdResult += Number(x.sdExam);
            dsResult += Number(x.dsExam);
            msResult += Number(x.msExam);
            var result = [{ 'result': 'SD', 'value': sdResult },
    ...
    ProfileListComponent.prototype.computeFinal = function (list) {
        for (var _i = 0, list_2 = list; _i < list_2.length; _i++) {
            ...
            var sdResult = this.getResultForTrack('SD', result1, result2, result3) + x.sdInterview;
            var msResult = this.getResultForTrack('MS', result1, result2, result3) + x.msInterview;
            var dsResult = this.getResultForTrack('DS', result1, result2, result3) + x.dsInterview;
            var result = [{ 'result': 'SD', 'value': sdResult },
                { 'result': 'DS', 'value': dsResult },
                { 'result': 'MS', 'value': msResult }];
            result.sort(function (a, b) { return b.value - a.value; });
    ...
    ProfileListComponent.prototype.profileResult = function (value) {
        var result1 = JSON.parse(this.initial ? value.initialResult1 : value.finalResult1)['result'];
        var result2 = JSON.parse(this.initial ? value.initialResult2 : value.finalResult2)['result'];
        var result3 = JSON.parse(this.initial ? value.initialResult3 : value.finalResult3)['result'];
...
module.exports = "<app-page [contentPanel]=\"contentPanel\"></app-page>\r\n\r\n<ng-template #contentPanel>\r\n    <div class=\"widget-container\">\r\n        <div class=\"item\"><nvd3 [options]=\"studentPerTrackChartOptions\" [data]=\"studentPerTrackChartData\"></nvd3></div>\r\n        <div class=\"item\"><nvd3 [options]=\"choiceAgainstResultOptions\" [data]=\"choiceAgainstResultData\"></nvd3></div>\r\n        <div class=\"item\"><nvd3 [options]=\"genderDistributionOptions\" [data]=\"genderDistributionData\"></nvd3></div>\r\n    </div>\r\n</ng-template>"
...
var ReportListComponent = /** @class */ (function () {
    ...
    ReportListComponent.prototype.studentPerTrackChart = function () {
        ...
        this.db.getProfileByResult('result', '2019').subscribe(function (data) {
...
var StudentEditComponent = /** @class */ (function (_super) {
    ...
    StudentEditComponent.prototype.saveGrade = function () {
        ...
        for (var _i = 0, newGradeList_1 = newGradeList; _i < newGradeList_1.length; _i++) {
            ...
            this.dbGrade.addGrade(x).subscribe(function (data) {
                count--;
                if (count === 0) {
                    _this.showSuccess();
                    _this.router.navigate(['/students']);
    ...
    StudentEditComponent.prototype.getGrade = function () {
    };
    ...
    StudentEditComponent.prototype.loadGradeList = function () {
        var _this = this;
        this.dbGrade.getGrade(this.editId).subscribe(function (data) { return _this.gradeList = data; });
    };
