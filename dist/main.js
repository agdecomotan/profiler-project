...
var ProfileListComponent = /** @class */ (function (_super) {
    ...
    ProfileListComponent.prototype.performInitialProfile = function (list) {
        ...
        var _loop_2 = function (x) {
            ...
            var dsResult = 0;
            var msResult = 0;
            var getSDGrade = x.grades.filter(function (c) { return c.courseSpecialization === 'SD'; }).forEach(function (f) { return sdResult += (5 - Number(f.value)); });
            var getDSGrade = x.grades.filter(function (c) { return c.courseSpecialization === 'DS'; }).forEach(function (f) { return dsResult += (5 - Number(f.value)); });
            var getMSGrade = x.grades.filter(function (c) { return c.courseSpecialization === 'MS'; }).forEach(function (f) { return msResult += (5 - Number(f.value)); });
